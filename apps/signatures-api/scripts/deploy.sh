...
aws lambda update-function-code --function-name cometa-dev-signatures --s3-bucket "$BUCKET" --s3-key signatures-api/signatures-api.zip --query 'CodeSize' --output text
