...
Docs: ${n}`),
    ...
    const _ = s(
        class e extends b {
          ...
          errors;
          constructor(t, r) {
            const { data: n, status: i, clerkTraceId: o, retryAfter: s } = r;
            super({ ...r, message: t, code: "api_response_error" }),
              Object.setPrototypeOf(this, e.prototype),
              (this.status = i),
              (this.clerkTraceId = o),
              (this.retryAfter = s),
              (this.errors = (n || []).map((e) => new y(e)));
          }
          toString() {
            let e = `[${this.name}]
Message:${this.message}
...
Clerk Trace ID: ${this.clerkTraceId}`),
    ...
    const C = {
      ...
      j = new Set(["strict_mfa", "strict", "moderate", "lax"]),
      O = (e, t) => {
      ...
      M = (e) => {
        let t, r;
        if (!e) return !1;
        const n = "string" == typeof e && j.has(e),
          i =
            "object" == typeof e &&
            ((t = e.level), E.has(t)) &&
    ...
    z((e) => (e ? e.replace(/[A-Z]/g, (e) => `_${e.toLowerCase()}`) : "")),
      z((e) => (e ? e.replace(/([-_][a-z])/g, (e) => e.toUpperCase().replace(/-|_/, "")) : ""));
    const I = [
        ".lcl.dev",
        ".stg.dev",
        ".lclstage.dev",
    ...
    let $ = new WeakMap(),
      ...
      er = (e, t) => {
        ...
        return [
          ...
          (n) => {
            if (!J(t)) {
              const i = e.get(t);
              t in X || (X[t] = i), r[5](t, Y(i, n), i || H);
            }
          },
          r[6],
          () => (!J(t) && t in X ? X[t] : (!J(t) && e.get(t)) || H),
        ];
      },
      en = !0,
      [ei, eo] =
      ...
      es = {
        initFocus: (e) => (
          ...
          ei("focus", e),
          () => {
            ee && document.removeEventListener("visibilitychange", e), eo("focus", e);
          }
        ),
        initReconnect: (e) => {
          const t = () => {
      ...
      ea = !W.default.useId,
      el = !Q || et,
      eu = el ? W.useEffect : W.useLayoutEffect,
    ...
    async function ey(...e) {
      ...
      async function d(r) {
        ...
        const [c, h] = er(t, d),
          ...
          k = () => {
            ...
            return ("function" == typeof o.revalidate
              ? o.revalidate(c().data, r)
              : !1 !== o.revalidate) && (delete g[d], delete m[d], e && e[0])
              ? e[0](2).then(() => c().data)
              : c().data;
          };
        ...
        const _ = !J(l),
          ...
          C = J(w) ? S : w;
        if (
          (_ && h({ data: (l = "function" == typeof l ? l(C, S) : l), _c: C }),
          "function" == typeof v)
        )
          try {
            v = v(C);
        ...
        if (
          (s &&
            !y &&
            ("function" == typeof s
              ? h({ data: s(v, C), error: q, _c: q })
              : h({ data: v, error: q, _c: q })),
          (f[d][1] = ev()),
          ...
          let r = Y(es, t),
            ...
            u = () => {
              if (
                ...
                const t = r.initFocus(setTimeout.bind(q, eb.bind(q, n, 0))),
                  i = r.initReconnect(setTimeout.bind(q, eb.bind(q, n, 1)));
                o = () => {
                  t && t(), i && i(), $.delete(e);
                };
              }
      ...
      ew = Y(
        {
          ...
          onErrorRetry: (e, t, r, n, i) => {
            const o = r.errorRetryCount,
              s = i.retryCount,
              a = ~~((Math.random() + 0.5) * (1 << (s < 8 ? s : 8))) * r.errorRetryInterval;
            (J(o) || !(s > o)) && setTimeout(n, a, i);
          },
          onDiscarded: K,
          revalidateOnFocus: !0,
          ...
          compare: function e(t, r) {
            ...
            if (t && r && (n = t.constructor) === r.constructor) {
              ...
              if (!n || "object" == typeof t) {
                for (n in ((i = 0), t))
                  if ((V.call(t, n) && ++i && !V.call(r, n)) || !(n in r) || !e(t[n], r[n]))
                    return !1;
      ...
      eC = (e, t) => {
        ...
        if (t) {
          const { use: n, fallback: i } = e,
            { use: o, fallback: s } = t;
          n && o && (r.use = n.concat(o)), i && s && (r.fallback = Y(i, s));
        }
        return r;
      },
    ...
    var ej = e.i(3861);
    const eO = "$inf$",
      eU = Q && window.__SWR_DEVTOOLS_USE__,
      eM = eU ? window.__SWR_DEVTOOLS_USE__ : [],
      ez = (e) =>
        "function" == typeof e[1]
          ? [e[0], e[1], e[2] || {}]
          : [e[0], null, (null === e[1] ? e[2] : e[1]) || {}],
      eI = () => Y(ew, (0, W.useContext)(eE)),
      eT = eM.concat((e) => (t, r, n) => {
        const i =
          r &&
          ((...e) => {
            const [n] = em(t),
              [, , , i] = $.get(eP);
            if (n.startsWith(eO)) return r(...e);
            const o = i[n];
            return J(o) ? r(...e) : (delete i[n], o);
          });
        return e(t, i, n);
      }),
      eA =
        ...
        (...r) => {
          const [n, i, o] = ez(r),
            s = (o.use || []).concat(t);
          return e(n, i, { ...o, use: s });
        };
    eU && (window.__SWR_DEVTOOLS_REACT__ = W.default);
    let eL = () => {},
      eR = eL(),
      ex =
        (new WeakMap(),
      ...
      eW = G.defineProperty(
        (e) => {
          const { value: t } = e,
            r = (0, W.useContext)(eE),
            n = "function" == typeof t,
            i = (0, W.useMemo)(() => (n ? t(r) : t), [n, r, t]),
            o = (0, W.useMemo)(() => (n ? i : eC(r, i)), [n, r, i]),
            s = i && i.provider,
            a = (0, W.useRef)(q);
          s && !a.current && (a.current = e_(s(o.cache || eP), i));
          const l = a.current;
          return (
            ...
            (0, W.createElement)(eE.Provider, Y(e, { value: o }))
          );
        },
        "defaultValue",
        { value: ew },
      ...
      eD =
        ((t = (e, t, r) => {
          const {
            ...
            P = (0, W.useRef)(t),
            S = (0, W.useRef)(r),
            w = () => S.current.isVisible() && S.current.isOnline(),
            [C, E, j, O] = er(n, k),
            U = (0, W.useRef)({}).current,
            M = J(s) ? (J(r.fallback) ? q : r.fallback[k]) : s,
            z = (e, t) => {
              for (const r in U)
                if ("data" === r) {
                  if (!i(e[r], t[r]) && (!J(e[r]) || !i(F, t[r]))) return !1;
                } else if (t[r] !== e[r]) return !1;
              return !0;
            },
            I = (0, W.useMemo)(() => {
              let e = !!k && !!t && (J(a) ? !S.current.isPaused() && !o && !1 !== l : a),
                r = (t) => {
                  const r = Y(t);
            ...
            L = p[k] && p[k].length > 0,
            R = T.data,
            x = J(R) ? (M && "function" == typeof M.then ? ex(M) : M) : R,
            N = T.error,
            D = (0, W.useRef)(x),
            F = h ? (J(R) ? (J(D.current) ? x : D.current) : R) : x,
            V =
              (!L || !!J(N)) &&
              (A && !J(a) ? a : !S.current.isPaused() && (o ? !J(x) && l : J(x) || l)),
            K = !!(k && t && A && V),
            G = J(T.isValidating) ? K : T.isValidating,
            H = J(T.isLoading) ? K : T.isLoading,
            X = (0, W.useCallback)(
              async (e) => {
                let t,
                  n,
                  o = P.current;
                if (!k || !o || b.current || S.current.isPaused()) return !1;
                let s = !0,
                  a = e || {},
                  l = !g[k] || !a.dedupe,
                  u = () => (ea ? !b.current && k === _.current && y.current : k === _.current),
                ...
                try {
                  if (
                    (l &&
                      ...
                      r.loadingTimeout &&
                        J(C().data) &&
                        setTimeout(() => {
                          s && u() && S.current.onLoadingSlow(k, r);
                        }, r.loadingTimeout),
                      (g[k] = [o(v), ev()])),
                    ([t, n] = g[k]),
                    (t = await t),
                    ...
                    return l && u() && S.current.onDiscarded(k), !1;
                  d.error = q;
                  const e = f[k];
                  if (!J(e) && (n <= e[0] || n <= e[1] || 0 === e[1]))
                    return c(), l && u() && S.current.onDiscarded(k), !1;
                  const a = C().data;
                  (d.data = i(a, t) ? a : t), l && u() && S.current.onSuccess(t, k, r);
                } catch (r) {
                  h();
                  const e = S.current,
                  ...
                  !e.isPaused() &&
                    ...
                    (!0 === t || ("function" == typeof t && t(r))) &&
                      (!S.current.revalidateOnFocus || !S.current.revalidateOnReconnect || w()) &&
                      e.onErrorRetry(
                        r,
                        k,
                        e,
                        (e) => {
                          const t = p[k];
                          t && t[0] && t[0](ej.ERROR_REVALIDATE_EVENT, e);
                        },
            ...
            ee = (0, W.useCallback)((...e) => ey(n, _.current, ...e), []);
          if (
            (eu(() => {
              (P.current = t), (S.current = r), J(R) || (D.current = R);
            }),
            eu(() => {
              var e;
              let t;
              ...
              let r = X.bind(q, eN),
                n = 0;
              S.current.revalidateOnFocus && (n = Date.now() + S.current.focusThrottleInterval);
              const i =
                ((e = (e, t = {}) => {
                  if (e == ej.FOCUS_EVENT) {
                    const e = Date.now();
                    S.current.revalidateOnFocus &&
                      e > n &&
                      w() &&
                      ((n = e + S.current.focusThrottleInterval), r());
                  } else if (e == ej.RECONNECT_EVENT) S.current.revalidateOnReconnect && w() && r();
                  else if (e == ej.MUTATE_EVENT) return X();
                  else if (e == ej.ERROR_REVALIDATE_EVENT) return X(t);
                }),
                (t = p[k] || (p[k] = [])).push(e),
                () => {
                  const r = t.indexOf(e);
              ...
              if (((b.current = !1), (_.current = k), (y.current = !0), E({ _k: v }), V && !g[k]))
                if (J(x) || el) r();
                else
                  Q && typeof window.requestAnimationFrame != Z
            ...
            eu(() => {
              ...
              function r() {
                !C().error && (d || S.current.isVisible()) && (c || S.current.isOnline())
                  ? X(eN).then(t)
                  : t();
              }
              return (
            ...
            (P.current = t), (S.current = r), (b.current = !1);
            const e = m[k];
            if ((J(e) || ex(ee(e)), J(N))) {
              const e = X(eN);
              J(F) || ((e.status = "fulfilled"), (e.value = !0)), ex(e);
            } else throw N;
          }
          return {
            mutate: ee,
      ...
      eJ = (e) => {
        let t,
          r,
          n = typeof e,
          i = eV.prototype.toString.call(e),
          o = eq(i, "Date"),
          s = eq(i, "RegExp"),
          a = eq(i, "Object");
        if (eV(e) !== e || o || s)
          ...
          if (((t = ++eG + "~"), eK.set(e, t), Array.isArray(e))) {
            for (r = 0, t = "@"; r < e.length; r++) t += eJ(e[r]) + ",";
            eK.set(e, t);
          }
          if (a) {
            t = "#";
            const n = eV.keys(e).sort();
      ...
      eH = eA(eD, (e) => (t, r, n) => {
        ...
        try {
          ...
          })(t ? t(0, null) : null)[0]) && (i = eO + i);
        } catch (e) {}
        const [f, g, m] = er(s, i),
          k = (0, W.useCallback)(() => (J(f()._l) ? a : f()._l), [s, i, a]);
        ...
        const b = c && !o.current,
          _ = e(
            ...
            async (e) => {
              ...
              for (let e = 0; e < u; ++e) {
                ...
                let [f, g] = er(s, u),
                  ...
                  _ =
                    ...
                    (d && !e && !J(m)) ||
                    b ||
                    (m && !J(m[e]) && !n.compare(m[e], v));
                if (r && ("function" == typeof o ? o(v, c) : _)) {
                  const t = async () => {
                    if (u in p) {
                      const e = p[u];
                      delete p[u], (v = await e);
                    } else v = await r(c);
                    g({ data: v, _k: c }), (a[e] = v);
                  };
                  h ? k.push(t) : await t();
              ...
              return h && (await Promise.all(k.map((e) => e()))), g({ _i: q }), a;
            },
            n,
          ),
          P = (0, W.useCallback)(
          ...
          S = (0, W.useCallback)(
            (e) => {
              ...
              const [, n] = er(s, i);
              if (
                ("function" == typeof e ? (r = e(v())) : "number" == typeof e && (r = e),
                "number" != typeof r)
              )
                return eY;
              n({ _l: r }), (y.current = r);
    ...
    function eZ(e, t, r) {
      for (r of e.keys()) if (eQ(r, t)) return r;
    }
    function eQ(e, t) {
      var r, n, i;
      if (e === t) return !0;
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Array) {
          if ((n = e.length) === t.length) while (n-- && eQ(e[n], t[n]));
          return -1 === n;
        }
        if (r === Set) {
        ...
        if (r === Map) {
          if (e.size !== t.size) return !1;
          for (n of e)
            if (((i = n[0]) && "object" == typeof i && !(i = eZ(t, i))) || !eQ(n[1], t.get(i)))
              return !1;
          return !0;
        }
        ...
        if (!r || "object" == typeof e) {
          for (r in ((n = 0), e))
            if ((eX.call(e, r) && ++n && !eX.call(t, r)) || !(r in t) || !eQ(e[r], t[r])) return !1;
    ...
    const e0 = ea
      ...
      e1 = eA(eD, () => (e, t, r = {}) => {
        const { mutate: n } = eI(),
          ...
          a = (0, W.useRef)(0),
          [l, u, d] = ((e) => {
            const [, t] = (0, W.useState)({}),
              r = (0, W.useRef)(!1),
              n = (0, W.useRef)(e),
              i = (0, W.useRef)({ data: !1, error: !1, isValidating: !1 }),
              o = (0, W.useCallback)((e) => {
                let o = !1,
                  s = n.current;
                for (const t in e)
          ...
          })({ data: q, error: q, isMutating: !1 }),
          c = l.current,
          h = (0, W.useCallback)(async (e, t) => {
            ...
            const u = Y(Y({ populateCache: !1, throwOnError: !0 }, s.current), t),
              c = ev();
            (a.current = c), d({ isMutating: !0 });
            try {
              const t = await n(r, o.current(l, { arg: e }), Y(u, { throwOnError: !0 }));
              return (
                a.current <= c &&
          ...
          p = (0, W.useCallback)(() => {
            (a.current = ev()), d({ data: q, error: q, isMutating: !1 });
          }, []);
        return (
          eu(() => {
            (i.current = e), (o.current = t), (s.current = r);
          }),
          {
            trigger: h,
            reset: p,
    ...
    const e8 = (e, t) => {
      const { assertCtxFn: r = e3 } = t || {},
        n = W.default.createContext(void 0);
      return (
        (n.displayName = e),
        [
          n,
          () => {
            const t = W.default.useContext(n);
            return r(t, `${e} not found`), t.value;
          },
          () => {
            const e = W.default.useContext(n);
            return e ? e.value : {};
          },
        ]
      );
    };
    function e2({ swrConfig: e, children: t }) {
      return W.default.createElement(eW, { value: e }, t);
    }
    const [e5, e4] = e8("ClerkInstanceContext"),
      [e6, e7] = e8("UserContext"),
      [e9, te] = e8("ClientContext"),
      [tt, tr] = e8("SessionContext");
    W.default.createContext({});
    const [tn, ti] = e8("CheckoutContext"),
      to = ({ children: e, ...t }) =>
        W.default.createElement(tn.Provider, { value: { value: t } }, e),
      [ts, ta] = e8("OrganizationContext"),
      tl = ({ children: e, organization: t, swrConfig: r }) =>
        W.default.createElement(
          e2,
          { swrConfig: r },
          W.default.createElement(ts.Provider, { value: { value: { organization: t } } }, e),
        );
    function tu(e) {
      if (!W.default.useContext(e5)) {
...
Learn more: https://clerk.com/docs/components/clerk-provider`.trim(),
    ...
    const th = (e, t) => {
      const r = "boolean" == typeof e && e,
        n = (0, W.useRef)(r ? t.initialPage : (e?.initialPage ?? t.initialPage)),
        i = (0, W.useRef)(r ? t.pageSize : (e?.pageSize ?? t.pageSize)),
        o = {};
      for (const n of Object.keys(t)) o[n] = r ? t[n] : (e?.[n] ?? t[n]);
    ...
    const tf = { dedupingInterval: 6e4, focusThrottleInterval: 12e4 },
      ...
      tm = (e) => {
        let t,
          r,
          { fetcher: n, config: i, keys: o } = e,
          [s, a] = (0, W.useState)(i.initialPage ?? 1),
          l = (0, W.useRef)(i.initialPage ?? 1),
          u = (0, W.useRef)(i.pageSize ?? 10),
          d = i.enabled ?? !0,
          c = "cache" === i.__experimental_mode,
          h = i.infinite ?? !1,
          p = i.keepPreviousData ?? !1,
          f = i.isSignedIn,
          g = { ...tc(o), initialPage: s, pageSize: u.current },
          m =
            ((t = (0, W.useRef)(f)),
            (r = (0, W.useRef)(null)),
          ...
          k = !h && d && (!!c || !!n),
          {
            ...
            "boolean" == typeof f ? ((!0 === m && !1 === f) || (f && k) ? g : null) : k ? g : null,
            !c && n
              ? (e) =>
                  !1 === f || !1 === k ? null : n(tp(e, { type: o.queryKey[0], ...o.queryKey[2] }))
              : null,
          ...
          ),
          {
            ...
            (e) =>
              h && d && !1 !== f
                ? { ...tc(o), initialPage: l.current + e, pageSize: u.current }
                : null,
            (e) => {
              const t = tp(e, { type: o.queryKey[0], ...o.queryKey[2] });
              return n?.(t);
            },
            tg,
          ),
          M = (0, W.useMemo)(() => (h ? j : s), [h, j, s]),
          z = (0, W.useCallback)((e) => (h ? void O(e) : a(e)), [O, h]),
          I = (0, W.useMemo)(
            () => (h ? (S?.flatMap((e) => e?.data) ?? []) : (v?.data ?? [])),
            [h, v, S],
          ),
          T = (0, W.useMemo)(
            () => (h ? S?.[S?.length - 1]?.total_count || 0 : (v?.total_count ?? 0)),
            [h, v, S],
          ),
          A = h ? w : b,
          L = h ? C : y,
        ...
        return {
          ...
          isError: !!R,
          page: M,
          pageCount: Math.ceil((T - D) / u.current),
          fetchPage: z,
          fetchNext: x,
          fetchPrevious: N,
          hasNextPage: T - D * u.current > M * u.current,
          hasPreviousPage: (M - 1) * u.current > D * u.current,
          revalidate: h ? () => U() : () => P(),
    ...
    const ty = {
      ...
      t_ = "u" > typeof window ? W.default.useLayoutEffect : W.default.useEffect,
      tP = "useSession",
      tS = "useSessionList",
      tw = "useUser";
    function tC() {
      tu(tw);
      const e = e7();
      return (e4().telemetry?.record(N(tw)), void 0 === e)
    ...
    async function tj(e) {
      try {
        ...
        if (_(e) && e.errors.find(({ code: e }) => "session_reverification_required" === e))
          return {
            clerk_error: { type: "forbidden", reason: D, metadata: { reverification: void 0 } },
          };
        throw e;
      }
    }
    function tO({ hookName: e, resourceType: t, useFetcher: r, options: n }) {
      return (i) => {
        const { for: o, enabled: s, ...a } = i || {},
          l = o || "user";
        tu(e);
        const u = r(l),
          d = th(a, {
    ...
    const tU = (e) => {
      ...
      tz = W.default.createContext(null);
    tz.displayName = "ElementsContext";
    const tI = (e, t) => {
        if (!e)
          throw Error(
      ...
      tT = ({ stripe: e, options: t, children: r }) => {
        const n = W.default.useMemo(() => tR(e), [e]),
        ...
        W.default.useEffect(() => {
          let e = !0,
            r = (e) => {
              o((r) => (r.stripe ? r : { stripe: e, elements: e.elements(t) }));
            };
          return (
        ...
        return (
          W.default.useEffect(() => {
            ...
            const e = tD(t, a, ["clientSecret", "fonts"]);
            e && i.elements.update(e);
          }, [t, a, i.elements]),
          W.default.createElement(tz.Provider, { value: i }, r)
        );
      },
      tA =
        "Invalid prop `stripe` supplied to `Elements`. We recommend using the `loadStripe` utility from `@stripe/stripe-js`. See https://stripe.com/docs/stripe-js/react#elements-props-stripe for details.",
      tL = (e, t = tA) => {
        if (null === e || tW(e)) return e;
        throw Error(t);
      },
      tR = (e, t = tA) => {
        if (tN(e)) return { tag: "async", stripePromise: Promise.resolve(e).then((e) => tL(e, t)) };
        const r = tL(e, t);
        return null === r ? { tag: "empty" } : { tag: "sync", stripe: r };
      },
      tx = (e) => null !== e && "object" == typeof e,
      tN = (e) => tx(e) && "function" == typeof e.then,
      tW = (e) =>
        tx(e) &&
      ...
      tB = (e, t) => {
        ...
        const n = Object.prototype.toString.call(e) === tF;
        if (n !== (Object.prototype.toString.call(t) === tF)) return !1;
        if (!n && !r) return e === t;
        const i = Object.keys(e),
          o = Object.keys(t);
        if (i.length !== o.length) return !1;
        const s = {};
        for (let e = 0; e < i.length; e += 1) s[i[e]] = !0;
        for (let e = 0; e < o.length; e += 1) s[o[e]] = !0;
        const a = Object.keys(s);
        return a.length === i.length && a.every((r) => tB(e[r], t[r]));
      },
      tV = (e) => tI(W.default.useContext(tz), e),
      t$ =
        ((a = "payment"),
        (l = "u" < typeof window),
        ...
        ((n = l
          ? (e) => {
              ...
              return W.default.createElement("div", { id: t, className: n });
            }
          : ({
              id: e,
              className: t,
              ...
              onConfirm: g,
              onCancel: m,
              onShippingAddressChange: k,
              onShippingRateChange: v,
            }) => {
              let y,
                b = tV(`mounts <${r}>`),
                _ = "elements" in b ? b.elements : null,
                [P, S] = W.default.useState(null),
                w = W.default.useRef(null),
                C = W.default.useRef(null),
                [E, j] = (0, W.useState)(!1);
              tM(P, "blur", o),
                tM(P, "focus", s),
                tM(P, "escape", d),
                ...
                tM(P, "loaderror", h),
                tM(P, "loaderstart", p),
                tM(P, "networkschange", f),
                tM(P, "confirm", g),
                tM(P, "cancel", m),
                tM(P, "shippingaddresschange", k),
                tM(P, "shippingratechange", v),
                tM(P, "change", u),
                l &&
                  (y = () => {
                    j(!0), l(P);
                ...
                W.default.useLayoutEffect(() => {
                  if (null === w.current && null !== C.current && _) {
                    let e = null;
                    _ && (e = _.create(a, i)), (w.current = e), S(e), e && e.mount(C.current);
                  }
                }, [_, i]);
              const O = tU(i);
              return (
        ...
        (n.__elementType = a),
        n),
      [tK, tq] = e8("PaymentElementContext"),
      [tG, tJ] = e8("StripeUtilsContext"),
      tY = ({ children: e }) => {
        const t = (() => {
            const { stripe: e } = tV("calls useStripe()");
            return e;
          })(),
          r = (() => {
            const { elements: e } = tI(W.default.useContext(tz), "calls useElements()");
            return e;
          })();
      ...
      tH = ({ children: e }) => W.default.createElement(tG.Provider, { value: { value: {} } }, e),
      tX = ({ children: e, ...t }) => {
        const r = ((e = "user") => {
            let t,
              r =
              ...
              n = tk().__unstable__environment,
              { initializedPaymentMethod: i, initializePaymentMethod: o } = ((e) => {
                const { for: t = "user" } = e ?? {},
                  { organization: r } = ta(),
                  n = e7(),
                ...
                return (
                  ...
                  { initializedPaymentMethod: o, initializePaymentMethod: s }
                );
              })({ for: e }),
              s = n?.commerceSettings.billing.stripePublishableKey ?? void 0;
            return {
              stripe: ((e) => {
      ...
      tZ = (e) => {
        const { stripe: t, externalClientSecret: r, stripeAppearance: n } = tq(),
          i = (() => {
            let e = tk(),
              t = "en";
            try {
        ...
        return t && r
          ? W.default.createElement(
              ...
              W.default.createElement(tY, null, e.children),
            )
          : W.default.createElement(tH, null, e.children);
      },
      tQ = () => {
        throw Error(
    ...
    e.s(
      [
        ...
        ({ fallback: e }) => {
          ...
          return i && o
            ? W.default.createElement(t$, { fallback: e, onReady: c, options: d })
            : W.default.createElement(W.default.Fragment, null, e);
        },
        "__experimental_PaymentElementProvider",
        0,
        ({ children: e, ...t }) =>
          W.default.createElement(tX, t, W.default.createElement(tZ, null, e)),
        ...
        (e) => {
          ...
          const u = (0, W.useMemo)(
              () => o.__experimental_checkout({ planId: n, planPeriod: i, for: r }),
              [l.id, s?.id, n, i, r],
            ),
            d = (0, W.useSyncExternalStore)(
              (e) => u.subscribe(e),
              () => u.getState(),
              () => u.getState(),
            );
        ...
        0,
        () => {
          const { isPaymentElementReady: e, initializePaymentMethod: t } = tq(),
            { stripe: r, elements: n } = tJ(),
            { externalClientSecret: i } = tq(),
            o = (0, W.useCallback)(async () => {
              if (!r || !n) return tQ();
          ...
          return a
            ...
            : { submit: tQ, reset: tQ, isFormReady: !1, provider: void 0, isProviderReady: !1 };
        },
        ...
        (e) => {
          var t, r;
          const { domains: n, membershipRequests: i, memberships: o, invitations: s } = e || {};
          tu("useOrganization"), tv("useOrganization");
          const { organization: a } = ta(),
            ...
            p = e4();
          p.telemetry?.record(N("useOrganization"));
          const f =
              void 0 === n
                ? void 0
                : {
          ...
          const { keepPreviousData: t = !0, enabled: r = !0 } = e,
            ...
            o =
              n.__unstable__environment?.organizationSettings?.organizationCreationDefaults
                ?.enabled ?? !1;
          n.telemetry?.record(N("useOrganizationCreationDefaults"));
          const { queryKey: s } = ((e) => {
              const { userId: t } = e;
              return (0, W.useMemo)(
                () =>
        ...
        (e) => {
          ...
          tu("useOrganizationList"), tv("useOrganizationList");
          const i = th(t, { initialPage: 1, pageSize: 10, keepPreviousData: !1, infinite: !1 }),
            ...
            a = e4(),
            l = e7();
          a.telemetry?.record(N("useOrganizationList"));
        ...
        0,
        (e, t) => {
          const { __internal_openReverification: r, telemetry: n } = tk(),
            i = (0, W.useRef)(e),
            o = (0, W.useRef)(t);
          return (
            n?.record(
              N("useReverification", { onNeedsReverification: !!t?.onNeedsReverification }),
            ),
            t_(() => {
            ...
            (0, W.useCallback)(
              (...e) => {
                var t;
                return ((t = { openUIComponent: r, telemetry: n, ...o.current }),
                (e) =>
                  async (...r) => {
                    let n,
                      i = await tj(e(...r));
        ...
        () => {
          ...
          const e = tr(),
            t = e4();
          return (t.telemetry?.record(N(tP)), void 0 === e)
        ...
        () => {
          ...
          const e = e4(),
            t = te();
          return (e4().telemetry?.record(N(tS)), t)
    ...
    var t0 = S({ packageName: "@clerk/clerk-react" });
    function t1(e) {
    ...
    var [t3, t8] = e8("AuthContext"),
      ...
      rs = "<UserButton.MenuItems /> component needs to be a direct child of `<UserButton />`.",
      ra =
        ...
        const n = "string" == typeof t ? void 0 : t,
          i = (t) => {
            ...
            return i.loaded || (null == n ? void 0 : n.renderWhileLoading)
              ? W.default.createElement(e, { ...t, component: r, clerk: i })
              : null;
          };
    ...
    e.s(
      [
        ...
        (e = {}) => {
          ...
          const o = e4(),
            s = (0, W.useCallback)(
              async (e) => ((await rh(o), o.session) ? o.session.getToken(e) : null),
              [o],
            ),
            a = (0, W.useCallback)(async (...e) => (await rh(o), o.signOut(...e)), [o]);
          return (
            null == (t = o.telemetry) || t.record(N("useAuth", { treatPendingAsSignedOut: r })),
                      ...
                      : c && "pending" === t
                        ...
                        : e && d && r && i && o
                          ...
                          : e && d && r && !i
                            ...
                            : void 0)({
                  authObject: { ...e, getToken: a, signOut: s, has: c },
            ...
            })({ ...i, getToken: s, signOut: a }, { treatPendingAsSignedOut: r })
          );
        },
        "useEmailLink",
        0,
        (e) => {
          const { startEmailLinkFlow: t, cancelEmailLinkFlow: r } = W.default.useMemo(
            () => e.createEmailLinkFlow(),
            [e],
          );
          return (
            W.default.useEffect(() => r, []), { startEmailLinkFlow: t, cancelEmailLinkFlow: r }
          );
        },
        ...
        () => {
          ...
          const t = e4(),
            r = te();
          return (null == (e = t.telemetry) || e.record(N("useSignIn")), r)
        ...
        () => {
          ...
          const t = e4(),
            r = te();
          return (null == (e = t.telemetry) || e.record(N("useSignUp")), r)
...
${t}`));
    ...
    var rb = (e) => (t) => {
        try {
          return rk.default.Children.only(e);
        } catch {
          return t0.throw(t5(t));
        }
      },
      r_ = (e, t) => (
        e || (e = t), "string" == typeof e && (e = rk.default.createElement("button", null, e)), e
      ),
      rP =
        (e) =>
        (...t) => {
    ...
    function rC(e, t, r) {
      const n = e.displayName || e.name || t || "Component",
        i = (n) => (
          ...
          rk.default.createElement(e, { ...n })
        );
      return (i.displayName = `withMaxAllowedInstancesGuard(${n})`), i;
    }
    var rE = (e) => {
        const [t, r] = (0, rk.useState)(new Map());
        return e.map((e) => ({
          id: e.id,
          ...
          portal: () => {
            ...
            return r ? (0, rv.createPortal)(e.component, r) : null;
          },
        }));
      },
      rj = (e, t) => !!e && rk.default.isValidElement(e) && (null == e ? void 0 : e.type) === t,
      rO = (e, t) =>
        rz(
          {
            children: e,
      ...
      rM = (e) => {
        const t = [],
          r = [r0, rQ, rY, rK, rq];
        return (
          rk.default.Children.forEach(e, (e) => {
            r.some((t) => rj(e, t)) || t.push(e);
          }),
          t
        );
      },
      rz = (e, t) => {
        const {
          ...
          u = [];
        rk.default.Children.forEach(r, (e) => {
          if (!rj(e, i) && !rj(e, n) && !rj(e, o)) {
            e && !l && rm(rt(a));
            return;
          }
          const { props: t } = e,
          ...
          if (rj(e, i))
            if (rI(t, s)) u.push({ label: d });
            else {
              if (!rT(t)) return void rm(rr(a));
        ...
        return (
          u.forEach((e, t) => {
            if (rI(e, s)) return void m.push({ label: e.label });
            if (rT(e)) {
              const { portal: r, mount: n, unmount: i } = p.find((e) => e.id === t),
                { portal: o, mount: s, unmount: a } = f.find((e) => e.id === t);
              m.push({
                label: e.label,
                url: e.url,
                mount: n,
            ...
            if (rA(e)) {
              ...
              m.push({ label: e.label, url: e.url, mountIcon: n, unmountIcon: i }), k.push(r);
              return;
            }
          }),
          { customPages: m, customPagesPortals: k }
        );
      },
      rI = (e, t) => {
        const { children: r, label: n, url: i, labelIcon: o } = e;
      ...
      rL = (e, t) => {
        const { children: r, label: n, onClick: i, labelIcon: o } = e;
        return !r && !i && !o && t.some((e) => e === n);
      },
      rR = (e) => {
      ...
      rN =
        ...
        (e) =>
          new Promise((t, r) => {
            ...
            let a = n;
            if ((o && (a = null == n ? void 0 : n.querySelector(o)), i(a, o))) return void t();
            const l = new MutationObserver((e) => {
              for (const r of e)
                if (
                  (!a && o && (a = null == n ? void 0 : n.querySelector(o)),
            ...
            l.observe(n, u),
              s > 0 &&
                setTimeout(() => {
                  l.disconnect(), r(Error(`Timeout waiting for ${o}`));
                }, s);
          }));
    function rW(e, t) {
      const r = (0, rk.useRef)(),
        [n, i] = (0, rk.useState)("rendering");
      return (
        (0, rk.useEffect)(() => {
    ...
    var rD = (e) => (null == e ? void 0 : e.map(({ mountIcon: e, unmountIcon: t, ...r }) => r)),
      rF = class extends rk.default.PureComponent {
        constructor() {
          super(...arguments), (this.rootRef = rk.default.createRef());
        }
        componentDidUpdate(e) {
          var t, r, n, i;
          if (!("mount" in e) || !("mount" in this.props)) return;
          const o = ry(e.props, "customPages", "customMenuItems", "children"),
            s = ry(this.props.props, "customPages", "customMenuItems", "children"),
            a =
            ...
            u = rD(e.props.customMenuItems),
            d = rD(this.props.props.customMenuItems);
          (!tE(o, s) || !tE(u, d) || a || l) &&
        ...
        render() {
          ...
          return rk.default.createElement(
            rk.default.Fragment,
            null,
            !e && rk.default.createElement("div", { ...t }),
            this.props.children,
          );
        }
      },
      rB = (e) => {
        ...
        return rk.default.createElement(
          ...
          null == (t = null == e ? void 0 : e.customPagesPortals)
            ? void 0
            : t.map((e, t) => (0, rk.createElement)(e, { key: t })),
          null == (r = null == e ? void 0 : e.customMenuItemsPortals)
            ? void 0
            : r.map((e, t) => (0, rk.createElement)(e, { key: t })),
        );
      },
      rV = rp(
        ({ clerk: e, component: t, fallback: r, ...n }) => {
          const i = "rendering" === rW(t) || !e.loaded,
    ...
    function rK({ children: e }) {
      return rm(t6), rk.default.createElement(rk.default.Fragment, null, e);
    }
    function rq({ children: e }) {
      return rm(t7), rk.default.createElement(rk.default.Fragment, null, e);
    }
    var rG = Object.assign(
        rp(
          ({ clerk: e, component: t, fallback: r, ...n }) => {
            const i = "rendering" === rW(t) || !e.loaded,
              o = { ...(i && r && { style: { display: "none" } }) },
              { customPages: s, customPagesPortals: a } = rO(n.children);
            return rk.default.createElement(
              rk.default.Fragment,
              null,
              i && r,
              rk.default.createElement(
                ...
                rk.default.createElement(rB, { customPagesPortals: a }),
              ),
            );
          },
      ...
      rJ = (0, rk.createContext)({ mount: () => {}, unmount: () => {}, updateProps: () => {} });
    function rY({ children: e }) {
      return rm(rs), rk.default.createElement(rk.default.Fragment, null, e);
    }
    function rH({ children: e }) {
      return rm(ra), rk.default.createElement(rk.default.Fragment, null, e);
    }
    function rX({ children: e }) {
      return rm(rl), rk.default.createElement(rk.default.Fragment, null, e);
    }
    var rZ = Object.assign(
      rp(
        ({ clerk: e, component: t, fallback: r, ...n }) => {
          var i;
          const o = "rendering" === rW(t) || !e.loaded,
            s = { ...(o && r && { style: { display: "none" } }) },
            { customPages: a, customPagesPortals: l } = rO(n.children, {
            ...
            { customMenuItems: d, customMenuItemsPortals: c } = (({
              ...
              const l = [],
                ...
                d = [];
              rk.default.Children.forEach(e, (e) => {
                if (!rj(e, t) && !rj(e, i) && !rj(e, o)) {
                  e && !a && rm(ri);
                  return;
                }
                if (rj(e, i) || rj(e, o)) return;
                const { props: u } = e;
                rk.default.Children.forEach(u.children, (e) => {
                  if (!rj(e, r) && !rj(e, n)) {
                    e && rm(ro);
                    return;
                  }
                  ...
                  if (rj(e, r))
                    if (rL(t, s)) l.push({ label: i });
                    else {
                      if (!rR(t)) return void rm(rd);
                      const e = { label: i, labelIcon: o };
              ...
              const c = [],
                h = [];
              l.forEach((e, t) => {
                rR(e) && c.push({ component: e.labelIcon, id: t }),
              ...
              return (
                l.forEach((e, t) => {
                  if ((rL(e, s) && u.push({ label: e.label }), rR(e))) {
                    const { portal: r, mount: n, unmount: i } = p.find((e) => e.id === t),
                      o = { label: e.label, mountIcon: n, unmountIcon: i };
                    "onClick" in e ? (o.onClick = e.onClick) : "open" in e && (o.open = e.open),
                      u.push(o),
                      d.push(r);
                  }
                  if (rx(e)) {
              ...
              MenuItemsComponent: rY,
              MenuActionComponent: rH,
              MenuLinkComponent: rX,
              UserProfileLinkComponent: rq,
              UserProfilePageComponent: rK,
              allowForAnyChildren:
                null !=
          ...
          return rk.default.createElement(
            ...
            e.loaded &&
              rk.default.createElement(
                ...
                rk.default.createElement(rB, { customPagesPortals: l, customMenuItemsPortals: c }),
              ),
          );
        },
      ...
      ),
      {
        ...
        __experimental_Outlet: (e) => {
          const t = (0, rk.useContext)(rJ),
            r = { ...t, props: { ...t.props, ...e } };
          return rk.default.createElement(rF, { ...r });
        },
      },
    );
    function rQ({ children: e }) {
      return rm(t9), rk.default.createElement(rk.default.Fragment, null, e);
    }
    function r0({ children: e }) {
      return rm(re), rk.default.createElement(rk.default.Fragment, null, e);
    }
    var r1 = Object.assign(
        rp(
          ({ clerk: e, component: t, fallback: r, ...n }) => {
            const i = "rendering" === rW(t) || !e.loaded,
              o = { ...(i && r && { style: { display: "none" } }) },
              { customPages: s, customPagesPortals: a } = rU(n.children);
            return rk.default.createElement(
              rk.default.Fragment,
              null,
              i && r,
      ...
      r8 = (0, rk.createContext)({ mount: () => {}, unmount: () => {}, updateProps: () => {} }),
      r2 = Object.assign(
        rp(
          ({ clerk: e, component: t, fallback: r, ...n }) => {
            const i = "rendering" === rW(t) || !e.loaded,
              ...
              l = { ...n.organizationProfileProps, customPages: s },
              u = rM(n.children),
              d = {
        ...
        {
          OrganizationProfilePage: rQ,
          OrganizationProfileLink: r0,
          __experimental_Outlet: (e) => {
            const t = (0, rk.useContext)(r8),
              r = { ...t, props: { ...t.props, ...e } };
            return rk.default.createElement(rF, { ...r });
          },
        },
      ...
      r7 = rp(
        ({ clerk: e, component: t, fallback: r, ...n }) => {
          const i =
              "rendering" === rW(t, { selector: '[data-component-status="ready"]' }) || !e.loaded,
            o = { ...(i && r && { style: { display: "none" } }) };
          return rk.default.createElement(
            rk.default.Fragment,
            null,
    ...
    var ni = (e) => {
      ...
      no = (e, t, r) => t.has(e) || ni("Cannot " + r),
      ns = (e, t, r) => (no(e, t, "read from private field"), r ? r.call(e) : t.get(e)),
      na = (e, t, r) =>
        t.has(e)
          ...
          : t instanceof WeakSet
            ? t.add(e)
            : t.set(e, r),
      nl = (e, t, r, n) => (no(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r),
      nu = (e, t, r) => (no(e, t, "access private method"), r);
    const nd = {
        initialDelay: 125,
      ...
      np = async (e, t = {}) => {
        ...
        let n,
          ...
          h =
            ((r = { initialDelay: s, maxDelayBetweenRetries: a, factor: l, jitter: d }),
            (n = 0),
            async () => {
              let e;
              await nc(
    ...
    async function nf(e = "", t) {
      const { async: r, defer: n, beforeLoad: i, crossOrigin: o, nonce: s } = t || {};
      return np(
        () =>
          new Promise((t, a) => {
            ...
            o && l.setAttribute("crossorigin", o),
              (l.async = r || !1),
              (l.defer = n || !1),
    ...
    const nm = "failed_to_load_clerk_js",
      nk = "Failed to load Clerk",
      { isDevOrStagingUrl: nv } =
        ((o = new Map()),
        {
          isDevOrStagingUrl: (e) => {
            if (!e) return !1;
            let t = "string" == typeof e ? e : e.hostname,
              r = o.get(t);
            return void 0 === r && ((r = I.some((e) => t.endsWith(e))), o.set(t, r)), r;
          },
        }),
      ny = S({ packageName: "@clerk/shared" });
    function nb() {
    ...
    function n_(e, t) {
      return new Promise((r, n) => {
        ...
        t?.addEventListener("error", () => {
          o(a, l), n(new w(nk, { code: nm }));
        });
        const s = () => {
            !i && nb() && ((i = !0), o(a, l), r(null));
          },
          a = setTimeout(() => {
            i ||
              ((i = !0),
              o(a, l),
              nb() ? r(null) : n(new w(nk, { code: "failed_to_load_clerk_js_timeout" })));
          }, e);
        s();
        const l = setInterval(() => {
          i ? clearInterval(l) : s();
    ...
    const nP = async (e) => {
        ...
        if (nb()) return null;
        if (!e?.publishableKey) return ny.throwMissingPublishableKeyError(), null;
        const r = nS(e),
        ...
        return (
          nf(r, { async: !0, crossOrigin: "anonymous", nonce: e.nonce, beforeLoad: nw(e) }).catch(
            (e) => {
              throw new w(nk + (e.message ? `, ${e.message}` : ""), { code: nm, cause: e });
            },
          ),
          i
        );
      ...
      nS = (e) => {
        ...
        if (r) return r;
        let l = "";
        if (o && (!o || ((t = o), /^http(s)?:\/\//.test(t || "")) || ng(o)))
          l = (!o ? "" : ng(o) ? new URL(o, window.location.origin).toString() : o).replace(
            /http(s)?:\/\//,
            "",
          );
        else
          l =
            s && !nv(R(a)?.frontendApi || "")
              ? ((e) => {
                  let t;
                  if (!e) return "";
    ...
    const nE = (e, t, r, n, i) => {
        let { notify: o } = i || {},
          s = e.get(r);
        s || ((s = []), e.set(r, s)), s.push(n), o && t.has(r) && n(t.get(r));
      },
      nj = (e, t, r) => (e.get(t) || []).map((e) => e(r)),
      nO = (e, t, r) => {
        const n = e.get(t);
        ...
        ({ clerk: e, children: t, ...r }) => {
          const {
            ...
            f = async (t) => {
              let r;
              return (
                p && "object" == typeof p && "props" in p && (await rP(p.props.onClick)(t)),
                (r = {
                  forceRedirectUrl: o,
                  fallbackRedirectUrl: s,
                  signUpFallbackRedirectUrl: i,
            ...
            g = { ...h, onClick: f };
          return W.default.cloneElement(p, g);
        },
      ...
      rp(
        ({ clerk: e, children: t, ...r }) => {
          const { redirectUrl: n, ...i } = r,
            o = rb((t = r_(t, "Sign in with Metamask")))("SignInWithMetamaskButton"),
            s = async () => {
              !(async () => {
                await e.authenticateWithMetamask({ redirectUrl: n || void 0 });
              })();
            },
            a = async (e) => (await rP(o.props.onClick)(e), s()),
            l = { ...i, onClick: a };
          return W.default.cloneElement(o, l);
        },
        { component: "SignInWithMetamask", renderWhileLoading: !0 },
      ),
      rp(
        ({ clerk: e, children: t, ...r }) => {
          const { redirectUrl: n = "/", signOutOptions: i, ...o } = r,
            s = rb((t = r_(t, "Sign out")))("SignOutButton"),
            a = async (t) => (await rP(s.props.onClick)(t), e.signOut({ redirectUrl: n, ...i })),
            l = { ...o, onClick: a };
          return W.default.cloneElement(s, l);
        },
    ...
    var nI = { name: "@clerk/clerk-react", version: "5.61.3", environment: "production" },
      nT = class t {
        constructor(e) {
          na(this, k),
            (this.clerkjs = null),
              ...
              (() => {
                ...
                return (
                  ...
                  (r = new Map()),
                  {
                    ...
                    emit: (n, i) => {
                      t.set(n, i), nj(r, n, i), nj(e, n, i);
                    },
                    off: (...t) => nO(e, ...t),
                    prioritizedOff: (...e) => nO(r, ...e),
            ...
            (this.hydrateClerkJS = (e) => {
              ...
              return (
                ...
                null == (t = ns(this, f).internal.retrieveListeners("status")) ||
                  t.forEach((e) => {
                    this.on("status", e, { notify: !0 });
                  }),
                null == (r = ns(this, f).internal.retrieveListeners("queryClientStatus")) ||
                  r.forEach((e) => {
                ...
                void 0 === this.clerkjs.status && ns(this, f).emit(nU, "ready"),
                this.emitLoaded(),
                this.clerkjs
              );
            }),
            ...
            (this.__unstable__updateProps = async (e) => {
              const t = await nu(this, k, v).call(this);
            ...
            (this.authenticateWithGoogleOneTap = async (e) =>
              (await nu(this, k, v).call(this)).authenticateWithGoogleOneTap(e)),
            (this.__internal_loadStripeJs = async () =>
              (await nu(this, k, v).call(this)).__internal_loadStripeJs()),
          ...
          nl(this, p, r),
            ...
            nl(this, g, new nz(this)),
            this.options.sdkMetadata || (this.options.sdkMetadata = nI),
            ns(this, f).emit(nU, "loading"),
            ns(this, f).prioritizedOn(nU, (e) => nl(this, d, e)),
            ns(this, p) && this.loadClerkJS();
        }
        get publishableKey() {
          return ns(this, p);
        }
        ...
        static getOrCreateInstance(e) {
          return (
            (nC() &&
              ns(this, m) &&
              (!e.Clerk || ns(this, m).Clerk === e.Clerk) &&
              ns(this, m).publishableKey === e.publishableKey) ||
              nl(this, m, new t(e)),
            ns(this, m)
          );
        }
        ...
        get domain() {
          return "u" > typeof window && window.location
            ? nM(ns(this, c), new URL(window.location.href), "")
            : "function" == typeof ns(this, c)
              ? t0.throw(t4)
              : ns(this, c) || "";
        }
        get proxyUrl() {
          return "u" > typeof window && window.location
            ? nM(ns(this, h), new URL(window.location.href), "")
            : "function" == typeof ns(this, h)
              ? t0.throw(t4)
              : ns(this, h) || "";
        }
        ...
        get isSatellite() {
          return "u" > typeof window && window.location
            ...
            : "function" == typeof this.options.isSatellite && t0.throw(t4);
        }
        async loadClerkJS() {
          var t;
          if ("browser" === this.mode && !this.loaded) {
            "u" > typeof window &&
              ((window.__clerk_publishable_key = ns(this, p)),
            ...
            try {
              ...
              ns(this, f).emit(nU, "error"), console.error(e.stack || e.message || e);
              return;
            }
          }
        }
        ...
        get __internal_state() {
          return this.loaded && this.clerkjs ? this.clerkjs.__internal_state : ns(this, g);
        }
        get apiKeys() {
          var e;
    ...
    function nA(e) {
      ...
      let i,
        ...
        b,
        _,
        { isomorphicClerkOptions: P, initialState: S, children: w } = e,
        { isomorphicClerk: C, clerkStatus: E } = nL(P),
        [j, O] = W.default.useState({
          client: C.client,
          session: C.session,
          user: C.user,
          organization: C.organization,
        });
      W.default.useEffect(() => C.addListener((e) => O({ ...e })), []);
      const U =
          ((t = C.loaded),
          !t && S
            ? ((i = (r = S).userId),
            ...
            : ((u = (n = j).user ? n.user.id : n.user),
              ...
              (m = h?.actor),
              (k = n.organization),
              (v = n.organization ? n.organization.id : n.organization),
              (y = k?.slug),
              (_ = (b = k ? d?.organizationMemberships?.find((e) => e.organization.id === v) : k)
                ? b.permissions
                : b),
              {
                userId: u,
        ...
        M = W.default.useMemo(() => ({ value: C }), [E]),
        z = W.default.useMemo(() => ({ value: j.client }), [j.client]),
        {
          sessionId: I,
          sessionStatus: T,
          sessionClaims: A,
        ...
        q = W.default.useMemo(
          ...
          [I, T, R, D, N, B, V, K, null == A ? void 0 : A.__raw],
        ),
        G = W.default.useMemo(() => ({ value: L }), [I, L]),
        J = W.default.useMemo(() => ({ value: x }), [R, x]),
        Y = W.default.useMemo(() => ({ value: { organization: F } }), [N, F]);
      return W.default.createElement(
        e5.Provider,
        { value: M },
        W.default.createElement(
            ...
            W.default.createElement(
              ...
              W.default.createElement(
                ...
                W.default.createElement(
                  e6.Provider,
                  { value: J },
                  W.default.createElement(to, { value: void 0 }, w),
                ),
              ),
            ),
          ),
    ...
    (d = new WeakMap()),
      ...
      na(nT, m);
    var nL = (e) => {
        const t = W.default.useRef(nT.getOrCreateInstance(e)),
          [r, n] = W.default.useState(t.current.status);
        return (
          W.default.useEffect(() => {
          ...
          W.default.useEffect(
            () => (
              ...
              () => {
                t.current && t.current.off("status", n), nT.clearInstance();
              }
            ),
            [],
          ),
        ...
        (e) => {
          ...
          return (
            s ||
              n ||
              (o
                ? o && !x(o) && t0.throwInvalidPublishableKeyError({ key: o })
                : t0.throwMissingPublishableKeyError()),
            W.default.createElement(nA, { initialState: t, isomorphicClerkOptions: i }, r)
          );
        },
        "ClerkProvider",
        t2,
      );
    (nR.displayName = "ClerkProvider"),
      t1({ packageName: "@clerk/clerk-react" }),
      ny.setPackageName({ packageName: "@clerk/clerk-react" }),
      e.s(["ClerkProvider", 0, nR], 88886);
  },
]);
