(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    const n = e.r(53987).createRenderSearchParamsFromClient;
    ("function" == typeof r.default || ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
      Object.assign(r.default, r),
  ...
  (e, t, r) => {
    ...
    const n = e.r(65473).createRenderParamsFromClient;
    ("function" == typeof r.default || ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
      Object.assign(r.default, r),
          ...
          for (const e of Array.isArray(a)
            ...
            : ((e) => {
                ...
                var t,
                  ...
                  s = 0;
                function l() {
                  while (s < e.length && /\s/.test(e.charAt(s))) s += 1;
                  return s < e.length;
                }
                while (s < e.length) {
                  for (t = s, o = !1; l(); )
  ...
  (e, t, r) => {
      ...
      if (n)
        switch (n.type) {
          ...
          case "validation-client":
            return ((t, r, n) => {
              var a;
              const { createExhaustiveSearchParamsProxy: o } = e.r(81206);
    ...
    function v(t, r, n, a) {
      ...
      if (n.validationSamples) {
        const { createExhaustiveSearchParamsProxy: a } = e.r(81206),
  ...
  (e, t, r) => {
        ...
        switch (s.type) {
          ...
          case "request":
            if (s.asyncApiPromises && s.validationSamples)
              return ((t, r, n, a, o) => {
                const { createExhaustiveParamsProxy: i } = e.r(81206),
    ...
    function R(t, r, n) {
      const { createExhaustiveParamsProxy: a } = e.r(81206);
      return Promise.resolve(
  ...
  (e, t, r) => {
    ...
    function l({ Component: t, serverProvidedParams: r }) {
      ...
      if ("u" < typeof window) {
        let r,
          a,
          { createSearchParamsFromClient: o } = e.r(21055);
        r = o(c);
        const { createParamsFromClient: i } = e.r(53273);
        return (a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r });
      }
      {
        const { createRenderSearchParamsFromClient: r } = e.r(21109),
          a = r(c),
          { createRenderParamsFromClient: o } = e.r(56845),
          i = o(u);
  ...
  (e, t, r) => {
    ...
    function i({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ("u" < typeof window) {
        const { createParamsFromClient: a } = e.r(53273),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
      {
        const { createRenderParamsFromClient: a } = e.r(56845),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
    }
