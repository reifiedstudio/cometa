  ...
  (e) => {
    ...
    const o = (...e) =>
        e
          ...
          .trim(),
      t = (e) => {
        const r = e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, r, o) =>
      ...
      a = (0, r.forwardRef)(
        (
          ...
          const {
            ...
            k = (n ?? f) ? (24 * Number(a ?? u)) / Number(t ?? b) : (a ?? u);
          return (0, r.createElement)(
            ...
            [...c.map(([e, o]) => (0, r.createElement)(e, o)), ...(Array.isArray(d) ? d : [d])],
          );
        },
      );
    function n() {
    ...
    e.s(
      [
        ...
        0,
        (e, l) => {
          const s = (0, r.forwardRef)(({ className: s, ...n }, i) =>
            (0, r.createElement)(a, {
              ref: i,
              iconNode: l,
              className: o(
      ...
      e.s(["clsx", 0, n], 31373);
    const i = (e = new Map(), r = null, o) => ({ nextPart: e, validators: r, classGroupId: o }),
      d = [],
      c = (e, r, o) => {
      ...
      eh = ((e, ...r) => {
          ...
          a = (e) => {
            ...
            const s = ((e, r) => {
              ...
              for (let e = n.length - 1; e >= 0; e -= 1) {
                ...
                const g = 0 === c.length ? "" : 1 === c.length ? c[0] : s(c).join(":"),
                  h = m ? g + "!" : g,
                  k = h + f;
              ...
              (t = (o = {
                ...
                parseClassName: ((e) => {
                  ...
                  if (r) {
                    const e = r + ":",
                      o = t;
                    t = (r) => (r.startsWith(e) ? o(r.slice(e.length)) : x(w, !1, r, void 0, !0));
                  }
                  if (o) {
                    const e = t;
            ...
            s(
              ((...e) => {
                let r,
                  ...
                  t = 0,
                  l = "";
                while (t < e.length) (r = e[t++]) && (o = y(r)) && (l && (l += " "), (l += o));
                return l;
              })(...e),
            )
        );
        ...
        const e = j("color"),
          ...
          C = () => [Y, Z, i],
          N = () => [T, "full", "auto", ...C()],
          G = () => [S, "none", "subgrid", Y, Z],
          W = () => ["auto", { span: ["full", S, Y, Z] }, S, Y, Z],
          $ = () => [S, "auto", Y, Z],
          ...
          B = () => [T, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", ...C()],
          _ = () => [T, "screen", "full", "lh", "dvh", "lvh", "svh", "min", "max", "fit", ...C()],
          en = () => [e, Y, Z],
          ei = () => [...x(), eo, Q, { position: [Y, Z] }],
          ed = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
          ec = () => ["auto", "cover", "contain", et, K, { size: [Y, Z] }],
          em = () => [P, ee, D],
          ep = () => ["", "none", "full", d, Y, Z],
          eb = () => ["", M, ee, D],
        ...
        return {
          ...
          classGroups: {
            aspect: [{ aspect: ["auto", "square", T, Z, Y, g] }],
            container: ["container"],
            columns: [{ columns: [M, Z, Y, n] }],
            ...
            z: [{ z: [S, "auto", Y, Z] }],
            basis: [{ basis: [T, "full", "auto", n, ...C()] }],
            "flex-direction": [{ flex: ["row", "row-reverse", "col", "col-reverse"] }],
            "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
            flex: [{ flex: [M, T, "auto", "initial", "none", Z] }],
            grow: [{ grow: ["", M, Y, Z] }],
            shrink: [{ shrink: ["", M, Y, Z] }],
            order: [{ order: [S, "first", "last", "none", Y, Z] }],
            ...
            w: [{ w: [n, "screen", ...U()] }],
            "min-w": [{ "min-w": [n, "screen", "none", ...U()] }],
            "max-w": [{ "max-w": [n, "screen", "none", "prose", { screen: [a] }, ...U()] }],
            h: [{ h: ["screen", "lh", ...U()] }],
            "min-h": [{ "min-h": ["screen", "lh", "none", ...U()] }],
            "max-h": [{ "max-h": ["screen", "lh", ...U()] }],
            "font-size": [{ text: ["base", o, ee, D] }],
            "font-smoothing": ["antialiased", "subpixel-antialiased"],
            "font-style": ["italic", "not-italic"],
            "font-weight": [{ font: [t, ea, H] }],
            "font-stretch": [
              {
                "font-stretch": [
                  "ultra-condensed",
            ...
            tracking: [{ tracking: [l, Y, Z] }],
            "line-clamp": [{ "line-clamp": [M, "none", Y, F] }],
            leading: [{ leading: [s, ...C()] }],
            "list-image": [{ "list-image": ["none", Y, Z] }],
            "list-style-position": [{ list: ["inside", "outside"] }],
            "list-style-type": [{ list: ["disc", "decimal", "none", Y, Z] }],
            "text-alignment": [{ text: ["left", "center", "right", "justify", "start", "end"] }],
            "placeholder-color": [{ placeholder: en() }],
            "text-color": [{ text: en() }],
            "text-decoration": ["underline", "overline", "line-through", "no-underline"],
            "text-decoration-style": [{ decoration: [...eu(), "wavy"] }],
            "text-decoration-thickness": [{ decoration: [M, "from-font", "auto", Y, D] }],
            "text-decoration-color": [{ decoration: en() }],
            "underline-offset": [{ "underline-offset": [M, "auto", Y, Z] }],
            ...
            "bg-image": [
              {
                bg: [
                  "none",
                  {
                    linear: [{ to: ["t", "tr", "r", "br", "b", "bl", "l", "tl"] }, S, Y, Z],
                    radial: ["", Y, Z],
                    conic: [S, Y, Z],
                  },
                  el,
            ...
            "outline-offset": [{ "outline-offset": [M, Y, Z] }],
            "outline-w": [{ outline: ["", M, ee, D] }],
            "outline-color": [{ outline: en() }],
            shadow: [{ shadow: ["", "none", c, es, X] }],
            "shadow-color": [{ shadow: en() }],
            "inset-shadow": [{ "inset-shadow": ["none", m, es, X] }],
            "inset-shadow-color": [{ "inset-shadow": en() }],
            "ring-w": [{ ring: eb() }],
            "ring-w-inset": ["ring-inset"],
            "ring-color": [{ ring: en() }],
            "ring-offset-w": [{ "ring-offset": [M, D] }],
            "ring-offset-color": [{ "ring-offset": en() }],
            "inset-ring-w": [{ "inset-ring": eb() }],
            "inset-ring-color": [{ "inset-ring": en() }],
            "text-shadow": [{ "text-shadow": ["none", p, es, X] }],
            "text-shadow-color": [{ "text-shadow": en() }],
            opacity: [{ opacity: [M, Y, Z] }],
            ...
            "mask-image-radial": [{ "mask-radial": [Y, Z] }],
            ...
            "mask-image": [{ mask: ["none", Y, Z] }],
            filter: [{ filter: ["", "none", Y, Z] }],
            blur: [{ blur: eh() }],
            brightness: [{ brightness: [M, Y, Z] }],
            contrast: [{ contrast: [M, Y, Z] }],
            "drop-shadow": [{ "drop-shadow": ["", "none", b, es, X] }],
            "drop-shadow-color": [{ "drop-shadow": en() }],
            grayscale: [{ grayscale: ["", M, Y, Z] }],
            "hue-rotate": [{ "hue-rotate": [M, Y, Z] }],
            invert: [{ invert: ["", M, Y, Z] }],
            saturate: [{ saturate: [M, Y, Z] }],
            sepia: [{ sepia: ["", M, Y, Z] }],
            "backdrop-filter": [{ "backdrop-filter": ["", "none", Y, Z] }],
            "backdrop-blur": [{ "backdrop-blur": eh() }],
            "backdrop-brightness": [{ "backdrop-brightness": [M, Y, Z] }],
            "backdrop-contrast": [{ "backdrop-contrast": [M, Y, Z] }],
            "backdrop-grayscale": [{ "backdrop-grayscale": ["", M, Y, Z] }],
            "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [M, Y, Z] }],
            "backdrop-invert": [{ "backdrop-invert": ["", M, Y, Z] }],
            "backdrop-opacity": [{ "backdrop-opacity": [M, Y, Z] }],
            "backdrop-saturate": [{ "backdrop-saturate": [M, Y, Z] }],
            "backdrop-sepia": [{ "backdrop-sepia": ["", M, Y, Z] }],
            ...
            duration: [{ duration: [M, "initial", Y, Z] }],
            ease: [{ ease: ["linear", "initial", h, Y, Z] }],
            delay: [{ delay: [M, Y, Z] }],
            animate: [{ animate: ["none", k, Y, Z] }],
            backface: [{ backface: ["hidden", "visible"] }],
            perspective: [{ perspective: [f, Y, Z] }],
            ...
            "skew-x": [{ "skew-x": ex() }],
            "skew-y": [{ "skew-y": ex() }],
            transform: [{ transform: [Y, Z, "", "none", "gpu", "cpu"] }],
            ...
            "will-change": [{ "will-change": ["auto", "scroll", "contents", "transform", Y, Z] }],
            fill: [{ fill: ["none", ...en()] }],
            "stroke-w": [{ stroke: [M, ee, D, F] }],
