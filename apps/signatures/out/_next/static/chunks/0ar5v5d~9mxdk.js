          ...
          const l = s.render,
            u = ((e, t = {}) => {
              const { className: r, style: s, render: a } = e,
                ...
                v = m ? ("function" == typeof r ? r(l) : r) : void 0,
                y = m ? ("function" == typeof s ? s(l) : s) : void 0,
                b = m
                  ? ((e, t) => {
                      const r = {};
                      for (const s in e) {
              ...
              return ("u" > typeof document &&
                (m
                  ...
                  : i(null, null)),
              m)
                ? (void 0 !== v && (g.className = (0, d.mergeClassNames)(g.className, v)),
                  void 0 !== y && (g.style = (0, h.mergeObjects)(g.style, y)),
                  g)
                : f;
            })(s, a);
          return !1 === a.enabled
  ...
  (e) => {
    ...
    var r = e.i(34517),
      ...
      c = class extends a.Subscribable {
        ...
        destroy() {
          (this.listeners = new Set()), this.#y(), this.#b(), this.#s.removeObserver(this);
        }
        setOptions(e) {
        ...
        createResult(e, t) {
          ...
          if (t._optimisticResults) {
            const r = this.hasListeners(),
              a = !r && h(e, t),
              l = r && f(e, s, t, i);
            (a || l) && (v = { ...v, ...(0, n.fetchState)(m.data, e.options) }),
              "isRestoring" === t._optimisticResults && (v.fetchStatus = "idle");
          }
          let { error: b, errorUpdatedAt: g, status: x } = v;
          r = v.data;
          let R = !1;
            ...
            a?.isPlaceholderData && t.placeholderData === c?.placeholderData
              ...
              : (e =
                  "function" == typeof t.placeholderData
                    ...
                    : t.placeholderData),
              void 0 !== e && ((x = "success"), (r = (0, u.replaceData)(a?.data, e, t)), (y = !0));
          }
          ...
          const Q = "fetching" === v.fetchStatus,
            ...
            T = {
              ...
              isFetchedAfterMount:
                v.dataUpdateCount > d.dataUpdateCount || v.errorUpdateCount > d.errorUpdateCount,
              isFetching: Q,
              isRefetching: Q && !O,
              isLoadingError: E && !I,
    ...
    e.s([
      ...
      () => {
        const {
          ...
          queryFn: () => (0, s.fetchOverdueSignatures)(),
        });
        return (0, t.jsxs)("div", {
          ...
          children: [
            (0, t.jsxs)("div", {
              ...
              children: [
                (0, t.jsx)(n.Clock, { size: 20, className: "text-muted-foreground" }),
                (0, t.jsx)("h1", {
                  className: "text-lg font-semibold text-foreground",
                  children: "Overdue Requests",
                }),
              ],
            }),
            (0, t.jsx)("div", {
              ...
              children: o
                ...
                : c
                  ? (0, t.jsx)("div", {
                      className: "flex items-center justify-center py-20 text-muted-foreground",
                      children: "Failed to load overdue requests.",
                    })
                  : e?.length
                    ? (0, t.jsxs)("table", {
                        ...
                        children: [
                          (0, t.jsx)("thead", {
                            children: (0, t.jsxs)("tr", {
                              ...
                              children: [
                                ...
                                (0, t.jsx)("th", { className: "px-6 py-3", children: "Expired" }),
                          ...
                          (0, t.jsx)("tbody", {
                            ...
                            children: e.map((e) => {
                              const r = Math.ceil(
                                (Date.now() - new Date(e.expiresAt).getTime()) / 864e5,
                              );
                              return (0, t.jsxs)(
                                "tr",
                                {
                                  ...
                                  children: [
                                    ...
                                    (0, t.jsx)("td", {
                                      className: "px-6 py-3",
                                      children: (0, t.jsxs)(l.Badge, {
                                        className:
                                          "border bg-red-50 text-red-600 border-red-200/60",
                                        children: [r, " day", 1 !== r ? "s" : "", " overdue"],
                                      }),
                                    }),
                                    (0, t.jsx)("td", {
                                    ...
                                    (0, t.jsx)("td", {
                                      ...
                                      children: e.expiresAt
                                        ? new Date(e.expiresAt).toLocaleDateString("en-ZA", {
                                            day: "numeric",
                                            month: "short",
                                            year: "numeric",
                                          })
                    ...
                    : (0, t.jsxs)("div", {
                        ...
                        children: [
                          (0, t.jsx)(n.Clock, { size: 32, className: "mb-3 opacity-40" }),
                          (0, t.jsx)("p", {
                            className: "text-sm",
                            children: "No overdue requests",
                          }),
                        ],
                      }),
            }),
